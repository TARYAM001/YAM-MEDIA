...
export async function synthesizeToInstagramPost(
  ...
  const prompt = `
Tu es le community manager officiel de FasoNews, média digital burkinabè suivi par des milliers d'Africains.
...
Ajoute aussi : #BurkinaFaso #FasoNews #Actualités #Afrique
